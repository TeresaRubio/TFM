...
La realización de este trabajo fin de máster ha sido posible gracias a la dedicación como tutores de Carlos Peña Garay y Vicente Arnau Llombart, a todos los profesores del Máster en Bioinformática de la Universidad de Valencia por la formación recibida y a todas aquellas personas que siempre me han apoyado. Especial mención a la ayuda recibida de Jose Manuel Martí y Daniel Martínez por todo lo que he aprendido con vosotros. También quiero agradecer al grupo la oportunidad de haber podido colaborar en el proceso de elaboración de un artículo científico. Es para mi una gran satisfacción tener una publicación como segunda autora siendo aún estudiante de máster. Muchas gracias a todos, he crecido como investigadora y como persona con vuestra ayuda.
...
\addcontentsline{toc}{chapter}{Anexo I: \textit{Pipeline} de asignación taxonómica} % si queremos que aparezca en el índice
\input{Anexo.tex}
