...
Se ejecuta un \textit{script} por directorio y se obtienen las 3 tablas (que pueden encontrarse en el material suplementario o en la dirección \url{https://github.com/TeresaRubio/TFM/tree/a/Tablas}:
\begin{listing}[style=consola, numbers=none]
$ cd Saliva_DonorA
