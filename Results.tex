...
\begin{figure}[!h]
    \centering
    \includegraphics[width=5.5in]{./Figuras/cplxCrnch_HostLifeStyle_Saliva_unWeighted_Summary.png}
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=5.5in]{./Figuras/cplxCrnch_HostLifeStyle_Stool_unWeighted_Summary.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5.5in]{./Figuras/cplxCrnch_xWeighted_STAN_Summary.png}
