...
\begin{figure}[!h]
 \centering
  \subfigure{
    \includegraphics[angle=90, width=3in]{./Figuras/mqc_fastqc_per_base_sequence_quality_plot_1.png}}
  \subfigure{
    \includegraphics[angle=90, width=3in]{./Figuras/mqc_fastqc_per_sequence_quality_scores_plot_1.png}}
