...
Mide el grado de relación lineal entre dos variables cuantitativas ($X$ e $Y$) sobre una población y se calcula con la siguiente expresión:
\begin{equation}
